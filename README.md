...
<img src="man/figures/README-numeric_example-1.png" width="100%" /><img src="man/figures/README-numeric_example-2.png" width="100%" /><img src="man/figures/README-numeric_example-3.png" width="100%" /><img src="man/figures/README-numeric_example-4.png" width="100%" /><img src="man/figures/README-numeric_example-5.png" width="100%" /><img src="man/figures/README-numeric_example-6.png" width="100%" /><img src="man/figures/README-numeric_example-7.png" width="100%" />
    ...
    #> 2      bill_depth_mm    bill_length_mm    NA
    #> 3  flipper_length_mm    bill_length_mm    NA
    #> 4        body_mass_g    bill_length_mm    NA
    #> 5               year    bill_length_mm    NA
    #> 6     bill_length_mm     bill_depth_mm    NA
    #> 7      bill_depth_mm     bill_depth_mm     1
    #> 8  flipper_length_mm     bill_depth_mm    NA
    #> 9        body_mass_g     bill_depth_mm    NA
    #> 10              year     bill_depth_mm    NA
    #> 11    bill_length_mm flipper_length_mm    NA
    #> 12     bill_depth_mm flipper_length_mm    NA
    #> 13 flipper_length_mm flipper_length_mm     1
    #> 14       body_mass_g flipper_length_mm    NA
    #> 15              year flipper_length_mm    NA
    #> 16    bill_length_mm       body_mass_g    NA
    #> 17     bill_depth_mm       body_mass_g    NA
    #> 18 flipper_length_mm       body_mass_g    NA
    #> 19       body_mass_g       body_mass_g     1
    #> 20              year       body_mass_g    NA
    #> 21    bill_length_mm              year    NA
    #> 22     bill_depth_mm              year    NA
    #> 23 flipper_length_mm              year    NA
    #> 24       body_mass_g              year    NA
    #> 25              year              year     1
    #> 
    #> $corr$layers
    #> $corr$layers[[1]]
...
### `explore_categorical_columns`
    ...
    explore_categorical_columns(df, c('Sex','Clap'))
